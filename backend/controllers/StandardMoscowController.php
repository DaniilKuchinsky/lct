...
use core\services\standard\StandardMoscowService;
use Yii;
use yii\web\UploadedFile;

class StandardMoscowController extends BaseController
{
    private StandardMoscowService $srvStandard;


    public function __construct($id, $module, StandardMoscowService $srvStandard, $config = [])
    {
    ...
    {
        $searchModel  = new StandardMoscowSearch();
